      ...
      <footer className="bg-gray-100 dark:bg-gray-900">
        <div className="mx-auto max-w-5xl px-4 py-2 sm:px-6 lg:px-8">
          <p className="mx-auto mt-2 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 ">
            Designed and build by Rohit, 2024 &#169; All rights
            reserved.
          </p>

          <ul className="mt-8 flex justify-center gap-4 md:gap-4">
            <li>
              <Link
                to="https://www.linkedin.com/in/rohit-wankhede/"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <Link
                to="https://github.com/CDM-Rohit24/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
              >
